...
const questions = ref([
    {
        ...
        answer: 'Да, у меня есть опыт работы в коммерческих проектах, где я приобрел ценный опыт и навыки.',
        open: false,
    },
    {
        question: 'Как я отношусь к работе в коллективе?',
        answer: 'Я прекрасно умею работать в команде. Я коммуникабельный человек и готов вносить свой вклад в общее дело.',
        open: false,
    },
    {
        question: 'Готов ли я присоединиться к вашей команде?',
        answer: 'Конечно, я готов присоединиться к вашей команде и внести свой вклад в достижение общих целей.',
        open: false,
    },
])
